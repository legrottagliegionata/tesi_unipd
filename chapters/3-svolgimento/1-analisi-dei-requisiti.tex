...
La seconda settimana dello \stage{} l'ho stata dedicata all'analisi dei requisiti del progetto, un'attività cruciale che ho 
condotto insieme ai membri del \textit{team}. Con uesto processo ho potuto identificarei requisiti 
...
\noindent Per il dei requisiti, ho utilizzato un metodo efficace utilizzando Confluence e Jira. 
...
Inoltre, la funzionalità di Jira permette di modificare e riallocare le \textit{issues} con facilità, 
