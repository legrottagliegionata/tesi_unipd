...
\begin{figure}[!h] 
  \centering 
  \includegraphics[width=1\columnwidth]{obiettivi-soddisfatti} 
...
Ho realizzato anche tutte le funzionalità desiderabili (figura \ref{tab:obiettivi-desiderabili}), in particolare:
\begin{itemize}
