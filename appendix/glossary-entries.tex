...
\newacronym[description={\glslink{tdd}{Test-driven development}}]
...
\newglossaryentry{reflection}{
  name=\glslink{reflection}{Reflection},
  text=reflection,
  sort=reflection,
  description={La reflection è una funzionalità di un linguaggio di programmazione che consente di ispezionare, analizzare e modificare il proprio codice sorgente o oggetti in esecuzione.}
}

% Test-driven development
\newglossaryentry{TDDg}{
  name=\glslink{tdd}{TDD},
  text=Test-driven development (TDD),
  sort=TDD,
  description={Il Test-driven development (TDD) è un modello di sviluppo del software che prevede che la scrittura dei \textit{test} automatici avvenga prima di quella del codice sorgente che deve essere sottoposto a \textit{test} }
}
